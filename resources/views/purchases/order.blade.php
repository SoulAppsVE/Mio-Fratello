...
<div class="panel-body">
	<h3 class="title-hero">Orden de Compra</h3>
    	...
    	var app = new Vue({
		    ...
		    methods:{
		        ...
		        postForm: function () {
		        	this.submitted = true
		        	var self = this
					axios.post('/admin/purchase/orderc', { purchases: this.purchases, supplier: this.supplier, date: this.$refs.sellDate.value })
					  .then(function (response) {
					    console.log(JSON.stringify(response.data));
					    window.location.href = '{{ route("purchase.ordercs") }}';
					  })
