...
class ApiSellController extends Controller
{
    ...
    public function getSellAPI () {

        $transactions = DB::table('transactions')
        ->select('transactions.*', 'users.first_name as vendedor', 'clients.first_name as cliente')
    ...
    public function postAPI(Request $request)
        {
            ...
            DB::transaction(function() use ($request , $sells, $ref_no, &$total, &$total_cost_price, &$totalProductTax, $customer,$usuario, $paid, $productTax, &$transactionId){
            ...
            return response()->json(['id' => $transactionId,'message' => 'Venta éxitosa.']);
        }
