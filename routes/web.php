...
Route::group(['prefix'=>'admin', 'middleware' => ['auth', 'revalidate'] ], function(){
  ...
  Route::post('purchase/delete','PurchaseController@deletePurchase')->name('purchase.delete');
	...
	/*========================================================
		Tasa Rates
	=========================================================*/
	Route::get('tasa', 'TasaController@getIndex')->name('tasa.index');
	Route::post('tasa', 'TasaController@postTasa')->name('tasa.post');
	Route::post('tasa/delete','TasaController@deleteTasa')->name('tasa.delete');
	Route::post('tasa/edit', 'TasaController@editTasa')->name('tasa.edit');
	/*========================================================
		Warehouse Routes
	=========================================================*/
